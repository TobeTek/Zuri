                    ...
                    while True:
                        ...
                        if choice == "1":
                            ...
                            acctBalance[namePosition] = (
                                acctBalance[namePosition] - withdrawAmount
                            )
                            ...
                            acctBalance[namePosition] = (
                                acctBalance[namePosition] + depositAmount
                            )
                            print("Current Balance: #%g" % (acctBalance[namePosition]))
                            shelFile = shelve.open("sysdata")  # Write data to drive
                            shelFile["Balance"] = acctBalance
                            ...
                            if response in allowedUsers:
                                ...
                                acctBalance[allowedUsers.index(response)] = (
                                    acctBalance[allowedUsers.index(response)] + amt
                                )
                                shelFile = shelve.open("sysdata")  # Write data to drive
                                shelFile["Balance"] = acctBalance
                                shelFile.close()
                                ...
                                acctBalance[namePosition] = (
                                    acctBalance[namePosition] - amt
                                )
                                acctBalance[acctNumbers.index(response)] = (
                                    acctBalance[acctNumbers.index(response)] + amt
                                )
                                shelFile = shelve.open("sysdata")  # Write data to drive
                                shelFile["Balance"] = acctBalance
                                shelFile.close()
